package terrails.minedustry.common.tile.furnace;
...
public class FastFurnaceTileEntity extends TileEntityLockable implements ITickable, ISidedInventory{//, IEnergyStorage {
  ...
  /*  @Override
    ...
    public String getName(){
        return this.hasCustomName() ? this.furnaceCustomName : "container.md.fast.furnace.name";
    }
    ...
    public void update(){
        ...
        if (!this.getWorld().isRemote){
            ...
            if (flag != this.isBurning()){
                flag1 = true;
                BlockFastFurnace.setState(this.isBurning(), this.getWorld(), this.pos);
            }
        }
        if (flag1){
            this.markDirty();
